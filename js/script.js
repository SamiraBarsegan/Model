...
let isRussian = true;
  ...
  toggleButton.addEventListener('click', () => {
    ...
    if (isRussian) {
        ...
        aboutPend.innerHTML= `Age: 11 years (11/28/2014) <br>
        Height: 160 cm <br>Shoe size 40<br>
        Brown eyes, brunette`;
        ...
        footerCopy.innerHTML = `Copyright &copy; 2026 by <span class="author">Barseghyan Samira</span> | All Rights Reserved.`;
      } else {
        ...
        aboutPend.innerHTML= `Возраст: 11 лет (28.11.2014) <br>
        Рост: 160 см<br>Размер обуви 40<br>
        ...
        footerCopy.innerHTML = `Авторское право &copy; 2026 от <span class="author">Барсегян Самира</span> | Все права защищены.`;
      }
    });
